/*
 *     ExtractSuperclass.java  Dec 19, 2001
 *
...
public class ExtractSuperclass extends ExtractClass {

    public ExtractSuperclass() {
        super();
    }

    public ExtractSuperclass(JFrame f, JavaClass jc, String dir, String name) {
    ...
    protected void preconditions() throws RefactoringException {
        if (newName == null) {
            newName = NewNameDialog.show(frame, "Extract Superclass");
        }
    ...
    protected void transform() throws RefactoringException {
        RefactoringVisitor transformer = new ExtractSuperclassVisitor(jclass, newName);
